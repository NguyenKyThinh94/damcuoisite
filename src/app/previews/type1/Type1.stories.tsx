...
const meta: Meta<typeof Type1> = {
  title: 'Previews/BinhThuong/Type1',
  component: Type1,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Wedding website template inspired by Zola\'s Summerlin Peachy design. Features a full-screen hero, navigation, story sections, and photo gallery with peachy color scheme. Data is fetched from API endpoint /api/binhthuong/type1.',
      },
    },
  },
  tags: ['autodocs'],
