...
export default function BannerType2({
  ...
  return (
    <div className="">
      ...
      <div id="banner-text" className="relative h-screen flex items-center justify-center bg-white text-[#4a4a4a]">
        <div className="z-10 flex flex-col justify-around items-center w-full max-w-[1200px] mx-auto">
          <Background
            src="https://iili.io/K7m7LUg.png"
            alt="Banner background"
            className="absolute"
            priority
          />
          <div className="text-[4rem] leading-[1.4em] mb-20 hidden md:block font-bold text-center">
            <div>{groomName}</div>
          ...
          <div className="text-lg md:text-xl font-bold mb-20 text-center w-full">
            {brideWeddingDate ? (
              <>
